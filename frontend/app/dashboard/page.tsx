...
export default function DashboardOverview() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* Hero Section */}
      <div className="bg-navy rounded-xl shadow-lg p-8 md:p-12 relative overflow-hidden text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-500 mt-1">
                {apiOnline 
                  ...
                  : "Start the backend server on port 3201."}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-border-color p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-lg font-semibold text-slate-800">Session Stats</h2>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-4 space-y-2 text-center h-[calc(100%-2rem)]">
            ...
            {historyCount === 0 && (
              <p className="text-xs text-slate-400 mt-2">
                No assessments have been completed in this session.
              </p>
            )}
            {historyCount > 0 && (
              <Link href="/dashboard/history" className="text-sm text-blue-600 hover:underline mt-4">
                View History
              </Link>
            )}
          </div>
